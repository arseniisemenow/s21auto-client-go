...
type CalendarAddEvent_Data_EventSlot struct {
	...
	Start    time.Time                    `json:"start"`
	End      time.Time                    `json:"end"`
	Event    CalendarAddEvent_Data_Event  `json:"event"`
	School   CalendarAddEvent_Data_School `json:"school"`
	Typename string                       `json:"__typename"`
}

type CalendarAddEvent_Data_Event struct {
	EventUserRole string `json:"eventUserRole"`
	Typename      string `json:"__typename"`
}

type CalendarAddEvent_Data_School struct {
